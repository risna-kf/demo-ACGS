          ...
          <div>
            ...
            <div className="contactInfo">
              <div className="contactItem">
                <MapPin className="contactIcon" size={18} strokeWidth={1.5} />
                <span>Batticaloa, Sri Lanka</span>
              </div>
              <div className="contactItem">
                <Phone className="contactIcon" size={18} strokeWidth={1.5} />
                <span>+94 XXX XXX XXX</span>
              </div>
              <div className="contactItem">
                <Mail className="contactIcon" size={18} strokeWidth={1.5} />
